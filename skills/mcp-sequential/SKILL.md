---
name: "mcp-sequential"
description: "Sequential Thinking MCP for complex reasoning, multi-step problem solving, debugging, and architectural decisions. Use when tasks require structured analysis, hypothesis testing, or course correction."
triggers:
  - "think through"
  - "step by step"
  - "analyze this"
